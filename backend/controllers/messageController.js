...
const getConversations = async (req, res) => {
  try {
    const conversations = await Conversation.find({ participants: req.user._id })
      ...
      .populate('book', 'title image price condition status')
      .sort('-lastMessageAt');
...
const sendMessage = async (req, res) => {
  try {
    ...
    // If bookId is provided, we look for a conversation about that book. Otherwise, we look for a general conversation.
    let conversation = bookId
